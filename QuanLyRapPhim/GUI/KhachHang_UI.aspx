<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KhachHang_UI.aspx.cs" Inherits="GUI.KhachHang_UI" %>
                ...
                <div class="wrapper" id="phim">
                    ...
                    <div class="informov">
                        <div class="hovereffect">
                            <a href="#" ><img src="../image/poster0.jpg" id="poster0" runat="server" class="img-responsive"></img></a>
                        </div>
                        <h5>TenPhim</h5>
                    ...
                    <div class="informov">
                        <div class="hovereffect">
                            <a href="#" ><img src="../image/poster1.jpg" class="img-responsive"></img></a>
                        </div>
                        <h5>TenPhim</h5>
                        <a class="btn btn-success" href="#"><i class="fa fa-ticket-alt" aria-hidden="true"></i> MUA VÉ</a>
                    </div>
                    ...
                    <div class="informov">
                        <div class="hovereffect">
                            <a href="#" ><img src="../image/poster2.jpg" class="img-responsive"></img></a>
                        </div>
                        <h5>TenPhim</h5>
                        <a class="btn btn-success" href="#"><i class="fa fa-ticket-alt" aria-hidden="true"></i> MUA VÉ</a>
                    </div>
                    ...
                    <div class="informov">
                        <div class="hovereffect">
                            <a href="#" ><img src="../image/poster3.jpg" class="img-responsive"></img></a>
                        </div>
                        <h5>TenPhim</h5>
                        <a class="btn btn-success" href="#"><i class="fa fa-ticket-alt" aria-hidden="true"></i> MUA VÉ</a>
                    </div>
                    ...
                    <div class="informov">
                        <div class="hovereffect">
                            <a href="#" ><img src="../image/poster4.jpg" class="img-responsive"></img></a>
                        </div>
                        <h5>TenPhim</h5>
                        <a class="btn btn-success" href="#"><i class="fa fa-ticket-alt" aria-hidden="true"></i> MUA VÉ</a>
                    </div>
                    ...
                    <div class="informov">
                        <div class="hovereffect">
                            <a href="#" ><img src="../image/poster5.jpg" class="img-responsive"></a>
                        </div>
                        <h5>TenPhim</h5>
                        <a class="btn btn-success" href="#"><i class="fa fa-ticket-alt" aria-hidden="true"></i> MUA VÉ</a>
                    </div>
