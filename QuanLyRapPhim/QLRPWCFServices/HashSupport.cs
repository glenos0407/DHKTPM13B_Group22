...
namespace QLRPWCFServices
{
    public class HashSupport
    {
        ...
        private static string Hash(string password, int iterations)
        {
            ...
            return string.Format("$KIENTRUCCOVAN$V1${0}${1}", iterations, base64Hash);
        }
        ...
        {
            return hashString.Contains("$KIENTRUCCOVAN$V1$");
        }
        ...
        public bool Verify(string password, string hashedPassword)
        {
            ...
            var splittedHashString = hashedPassword.Replace("$KIENTRUCCOVAN$V1$", "").Split('$');
